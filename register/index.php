    ...
    <body>
        ...
        <div class="container" style="margin-top:80px; margin-bottom:80px;">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 style="margin:10px 0 15px 0;">Personal Information</h5>
                    <form id="createAccount" action="processRegistration.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="address" name="address" placeholder="12345 Something ST NW" />
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#customerform').validate({
                ...
                messages: {
                    postalcode: { postalcode: "Postal code should be in the form A1A 1A1" },
                    businessphone: {
