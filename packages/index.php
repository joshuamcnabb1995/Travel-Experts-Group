                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card mb-4 box-shadow">
                                    <a href="#"><img class="card-img-top" style="height: 225px; width: 100%; display: block;" src="../img/packages/package1.jpg" data-holder-rendered="true"></a>
                                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4 box-shadow">
                                    <a href="#"><img class="card-img-top" style="height: 225px; width: 100%; display: block;" src="../img/packages/package2.jpg" data-holder-rendered="true"></a>
                                    <div class="card-body">
                                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis...</p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4 box-shadow">
                                    <a href="#"><img class="card-img-top" style="height: 225px; width: 100%; display: block;" src="../img/packages/package3.jpg" data-holder-rendered="true"></a>
                                    <div class="card-body">
                                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis...</p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
