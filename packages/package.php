			...
			<div class="container-fliud">
				<div class="wrapper row">
					...
					<div class="details col-md-6">
						...
						<div class="action"><button class="add-to-cart btn btn-success" type="button" onclick="window.location.href='order/?id=<?php echo $package['PackageId']; ?>'"><i class="fa fa-cart-plus"></i>&nbsp; Book Destination</button></div>
					</div>
				</div>
			</div>
		</div>
